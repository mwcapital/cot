#!/usr/bin/env python3
"""
Script to generate instruments_DisaggregatedF.json from CFTC API
This fetches all available instruments from the Disaggregated Futures report
and organizes them using the API's commodity hierarchy
"""
...
def fetch_all_instruments():
    """Fetch all unique instruments from CFTC Disaggregated API with all their metadata"""
    print("Connecting to CFTC API (Disaggregated Futures)...")
...
def generate_statistics(data):
    ...
    stats = {
        ...
        "api_info": {
            ...
            "report_type": "Disaggregated Futures",
...
def main():
    ...
    print("=" * 60)
    print("CFTC Disaggregated Instruments Database Generator")
    print("=" * 60)
    ...
    # Save to JSON file
    output_file = "instruments_DisaggregatedF.json"
